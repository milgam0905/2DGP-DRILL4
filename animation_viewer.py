...
def character_die():
    print("die")
    for x in range(0, 5):
        draw_frame(0, 8, 60, 70, 70, 400, 300, 200, 200)
        draw_frame(60, 8, 60, 70, 70, 400, 300, 200, 200)
        draw_frame(120, 8, 60, 70, 70, 400, 300, 200, 200)
        draw_frame(180, 8, 60, 70, 70, 400, 300, 200, 200)
        draw_frame(240, 8, 60, 70, 70, 400, 300, 200, 200)
        draw_frame(300, 8, 60, 70, 70, 400, 300, 200, 200)
