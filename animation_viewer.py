...
def character_attack_1():
    ...
    for x in range(0, 5):
        ...
        draw_frame(130, 3,  90, 90, 110, 390, 330, 350, 350)
        draw_frame(220, 3,  70, 90, 110, 390, 330, 320, 320)
...
def character_die():
    print("die")
    for x in range(0, 5):
        draw_frame(0, 8, 70, 72, 80, 400, 300, 200, 200)
        draw_frame(72*1+10, 8, 70, 72, 80, 400, 300, 200, 200)
        draw_frame(72*2+15, 8, 70, 72, 80, 400, 300, 200, 200)
        draw_frame(72*3+5, 8, 70, 72, 80, 400, 300, 200, 200)
        draw_frame(72*4-10, 8, 70, 72, 80, 400, 300, 200, 200)
